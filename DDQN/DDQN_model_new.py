...
class Agent:
    ...
    def build_target_model(self):
        ...
        target_model.add(Dense(64, input_dim=self.state_space, activation=relu))
        ...
        opt = SGD(lr=self.lr, momentum=0.9, clipnorm=1.0)
        target_model.compile(loss='mse', optimizer=opt)
        return target_model
    ...
    def align_target_model(self):
        ...
        for q_weight, target_weight in zip(q_model_theta, target_model_theta):
            target_weight = target_weight * 0.5 + q_weight * 0.5
